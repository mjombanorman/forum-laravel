...
<div class="panel panel-default">
    <div class="panel-heading text-center">Update the Discussion</div>
    ...
    <div class="form-group">
        ...
        <textarea name="content" id="content" cols="28" class="form-control" rows="10">{{$discussion->content}}</textarea>
    </div>
